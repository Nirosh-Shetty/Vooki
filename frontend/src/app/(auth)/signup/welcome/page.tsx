            ...
            {roles.map((role) => {
              ...
              return (
                <button
                  ...
                  className={`w-full p-3.5 rounded-2xl border-2 transition-all duration-300 text-left group ${isSelected
                ...
                >
                  <div className="flex items-center">
                    <div
                      className={`w-10 h-10 rounded-xl flex items-center justify-center mr-3.5 transition-colors ${isSelected
